...
app.get('/led/:etat', function(req, res) {
    ...
    switch(etat) {
        ...
        default: res.setHeader('Content-Type', 'text/plain');
                 res.end('Erreur seul /led/on, /led/off, /led/clign ou /led/basc autoris&eacute;');
...
app.get('/led', function(req, res) {
    ...
    switch(etat) {
        ...
        default: res.setHeader('Content-Type', 'text/plain');
                 res.end('Erreur seul /led?etat=on, /led?etat=off, /led?etat=clign ou /led?etat=basc autoris&eacute;');
...
// car les routes sont analysees dans l'ordre
